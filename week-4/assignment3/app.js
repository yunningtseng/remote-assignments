        ...
        <div>
            <div className="nav">
                ...
                <div className="nav--mobile">
                    <button type="button" className="nav__btn" onClick={switchNavExpandHandler}>
                        <img id="nav__image" src={`img/${showNav ? "x" : "menu"}.png`} className="nav__btn--mobile" alt="" />
                    </button>
                </div>
            ...
            <div className="context">
                <div id="context__message" className="context__message" onClick={setWelcomeMessageHandler}>{welcomeMessage}</div>
            </div>
            ...
            <div className="context__container">
                ...
                <div>
                    <button type="button" className="context__btn" onClick={switchBoxExpandHandler}>Call to Action</button>
                </div>
            </div>

            {/* NOTE click 展開 box2 section */}
